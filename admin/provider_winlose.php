...
if (isset($_GET['strDate']) && isset($_GET['endDate'])) {
  ...
  $query_bet_provider = "SELECT * FROM bet_history WHERE tanggal_masuk >= '$strDate' AND tanggal_masuk <= '$endDate 23:59:59'";
...
<div class="row pb-2" style="padding-top: 80px;">
	<div class="col-sm-9">
		<h4 class="page-title"> Report Win Lose Provider </h4>
	</div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    searchButton.addEventListener('click', function () {
        // Mendapatkan nilai dari input strDate dan endDate
        var strDate = strDateInput.value;
        var endDate = endDateInput.value;

        // Membuat URL baru dengan menambahkan parameter strDate dan endDate
        var newUrl = window.location.origin + window.location.pathname + '?strDate=' + encodeURIComponent(strDate) + '&endDate=' + encodeURIComponent(endDate);
