...
function search() {
  ...
  $.ajax({
    url: '../admin_realtime/get_dp_history.php',
    method: 'GET',
    dataType: 'json',
  ...
  return tanggalMasuk.getDate() >= startDate.getDate() && tanggalMasuk <= endDate;
        ...
        if (typeFilter === 'deposit') {
          return item.jenis_form === 'deposit';
        } else if (typeFilter === 'manual_deposit') {
          return item.jenis_form === 'manual_deposit';
        } else {
          return true;
        }
      }).filter(function(item) {
         if (bcaChecked && briChecked && bniChecked && mandiriChecked && cimbniagaChecked && danamonChecked && permataChecked && neobankChecked && jagoChecked && sakukuChecked && bsiChecked && paninChecked && ovoChecked && danaChecked && linkajaChecked && gopayChecked && xlChecked && simpatiChecked) {
          return true;
        } else if (bcaChecked && item.tujuan_admin_bank === 'BCA') {
          return true;
        } else if (briChecked && item.tujuan_admin_bank === 'BRI') {
          return true;
        } else if (bniChecked && item.tujuan_admin_bank === 'BNI') {
         return true;
       } else if (mandiriChecked && item.tujuan_admin_bank === 'MANDIRI') {
         return true;
       } else if (cimbniagaChecked && item.tujuan_admin_bank === 'CIMBNIAGA') {
         return true;
        } else if (danamonChecked && item.tujuan_admin_bank === 'DANAMON') {
         return true;
       } else if (permataChecked && item.tujuan_admin_bank === 'PERMATA') {
         return true;
       } else if (neobankChecked && item.tujuan_admin_bank === 'NEOBANK') {
         return true;
       } else if (jagoChecked && item.tujuan_admin_bank === 'JAGO') {
         return true;
       } else if (sakukuChecked && item.tujuan_admin_bank === 'SAKUKU') {
         return true;
       } else if (bsiChecked && item.tujuan_admin_bank === 'BSI') {
          return true;
       } else if (paninChecked && item.tujuan_admin_bank === 'PANIN') {
          return true;
       } else if (ovoChecked && item.tujuan_admin_bank === 'OVO') {
         return true;
       } else if (danaChecked && item.tujuan_admin_bank === 'DANA') {
          return true;
       } else if (linkajaChecked && item.tujuan_admin_bank === 'LINKAJA') {
         return true;
       } else if (gopayChecked && item.tujuan_admin_bank === 'GOPAY') {
         return true;
       } else if (xlChecked && item.tujuan_admin_bank === 'XL') {
         return true;
       } else if (simpatiChecked && item.tujuan_admin_bank === 'SIMPATI') {
          return true;
       } else {
         return false;
       }
      ...
      for (var i = currentRow; i < Math.min(currentRow + 200, filteredData.length); i++) {
        ...
        var tujuanAdminNorek = addHyphens(filteredData[i].tujuan_admin_norek);
        ...
        row += "<td>" + norek + "</td>";
        row += "<td>" + filteredData[i].tujuan_admin_bank + "</td>";
        row += "<td>" + filteredData[i].tujuan_admin_namabank + "</td>";
        row += "<td>" + tujuanAdminNorek + "</td>";
        ...
        row += "<td>" + filteredData[i].potongan + "%" + "</td>";
        row += "<td>" + filteredData[i].promotiontitle + "</td>";
        row += "<td>" + filteredData[i].promotiondp + "%" + "</td>";
        row += "<td>" + nominal + "</td>";
      ...
      totalRow += "<td colspan='15'>TOTAL</td>";
      ...
      var navigationRow = '<tr><td colspan="21" align="center">' + prevLink + ' ( ' + rowRange + ' ) ' + nextLink + '</td></tr>';
