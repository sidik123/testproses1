...
// Query INSERT INTO
$query = "INSERT INTO dp_history (username, bank, nama_bank, norek, nominal, admin_note, jenis_form, proses_oleh, status, tanggal_masuk, tanggal_update, tujuan_admin_bank, tujuan_admin_namabank, tujuan_admin_norek, dicek_oleh) VALUES ('$username', '$bank', '$namaBank', '$norek', '$nominal', '$adminNote', '$jenisForm', '$prosesOleh', '$status', '$tanggalMasuk', '$tanggalUpdate', '$tujuanAdminBank', '$tujuanAdminNamaBank', '$tujuanAdminNorek', '$prosesOleh')";

// Query untuk mengambil data member berdasarkan username
