...
wss.on('connection', (ws) => {
  ...
  const interval = setInterval(() => {
    fetch('https://testproses1.cyberpannel.biz.id/admin_realtime/realtime_formwd.php') // Replace with the correct URL of your realtime_member.php file
...
// Start the server
const port = 6060; // You can change this to any port number you prefer
server.listen(port, () => {
